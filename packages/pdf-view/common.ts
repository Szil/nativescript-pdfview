...
export abstract class PDFViewCommon extends View {
  ...
  public static notifyOfEvent(eventName: string, pdfViewRef: WeakRef<PDFViewCommon>) {
...
export const defaultpageProperty = new Property<PDFViewCommon, string>({
  name: 'defaultpage',
});
defaultpageProperty.register(PDFViewCommon);

export const bookmarkPathProperty = new Property<PDFViewCommon, string>({
  name: 'bookmarkpath',
});
bookmarkPathProperty.register(PDFViewCommon);

export const bookmarkLabelProperty = new Property<PDFViewCommon, string>({
  name: 'bookmarklabel',
});
bookmarkLabelProperty.register(PDFViewCommon);
